      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 text-gray-600">
          ...
          <ChatTimer 
            ...
            lastMessageTimestamp={selectedConversation.last_message_timestamp}
        ...
        <div className="flex items-center bg-gray-100 rounded-lg px-2 py-1 gap-1 shadow-lg shadow-gray-200/50">
          <Button 
            ...
            className="h-7 w-7 text-gray-600 hover:text-green-600 hover:bg-green-50"
          >
            <Star className={`h-4 w-4 ${selectedConversation.favorite ? "text-yellow-500 fill-yellow-500" : ""}`} />
          </Button>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="icon" className="h-7 w-7 text-gray-600 hover:text-green-600 hover:bg-green-50">
