    ...
    <NodeContextProvider nodes={nodes} setNodes={setNodes} edges={edges} setEdges={setEdges}>
      <div className="h-full flex flex-col bg-gray-50">
        ...
        <div className="flex-1 flex relative">
          ...
          <button
            className="fixed top-1/2 right-2 z-40 bg-white border rounded-full shadow p-2 hover:bg-gray-100 transition-transform -translate-y-1/2"
          ...
          {sidebarOpen && (
            <div className="fixed inset-0 z-50 flex justify-end pointer-events-none">
              {/* No blur, no dark overlay, just close on outside click */}
              {/* Drawer */}
              <div className="relative h-full max-h-screen bg-white border-l border-gray-200 shadow-lg w-80 min-w-[240px] z-50 animate-slide-in-right overflow-y-auto pointer-events-auto">
                <button
                  className="absolute -left-4 top-4 z-50 bg-white border rounded-full shadow p-1 hover:bg-gray-100"
