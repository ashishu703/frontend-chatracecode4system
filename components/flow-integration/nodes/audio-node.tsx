...
import { Upload, X, Link2, Volume2, Copy, Play } from "lucide-react"
...
export function AudioNode({ data, selected, id }: any) {
  ...
  const [title, setTitle] = useState("Send Audio")
  ...
  useEffect(() => {
    ...
    setTitle(data?.title || "Send Audio")
  ...
  const updateKeyword = (index: number, value: string) => {
    ...
    setTimeout(() => {
      const newData = buildNodeData(audioUrl, captions, title, messageNumber, newKeywords, uploadedFile)
        ...
        <div className="px-3 py-2 border-b border-gray-100">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-0.5">Audio Message</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-3 py-2 space-y-3">
          ...
          {!useUrlInput ? (
            <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-lg p-6 text-center">
              ...
              <label htmlFor={`audio-upload-${id}`} className="cursor-pointer flex flex-col items-center">
